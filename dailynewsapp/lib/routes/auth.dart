import 'dart:async';
import 'package:dailynewsapp/views/profile.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:google_sign_in/google_sign_in.dart';
import 'package:dailynewsapp/logger.dart';
import 'package:dailynewsapp/widgets/google_sign_in_btn.dart';
import 'package:dailynewsapp/widgets/masked_text.dart';
import 'package:dailynewsapp/widgets/reactive_refresh_indicator.dart';
    ...
    await _onCodeVerified(user).then((result) {
      if (result) {
        Navigator.of(context).pushReplacement(CupertinoPageRoute(
          builder: (context) => ProfileScreen(googleUser: _googleUser,
            firebaseUser: user,),
        ));
      } else {
        setState(() {
    ...
    return Container(
      child: MaskedTextField(
        ...
        style: Theme.of(context)
            .textTheme
            .subhead
            .copyWith(fontSize: 25.0, color: Colors.white,backgroundColor: Colors.black,fontWeight: FontWeight.bold),
        inputDecoration: InputDecoration(
          ...
          labelStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 26,backgroundColor: Colors.red),
          hintText: "9999999999",
          hintStyle: hintStyle,
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            "We'll send a OTP message to verify your identity, please enter your number!",
            style: TextStyle(color: Colors.black,fontSize: 18,backgroundColor: Colors.white,fontWeight: FontWeight.bold),
